...
// Algorithm to calculate double value of log2, with a decimal precision interval of 1/12
...
// Converts a sound's fundamental frequency value to the correct octave specific musical tone
// Values used:
// A4 = 440;
